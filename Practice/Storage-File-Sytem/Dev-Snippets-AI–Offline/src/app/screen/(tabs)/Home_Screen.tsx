  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.topContainer}>
        <DevHeading style={styles.topTitle}>All Snippets</DevHeading>
        <DevText numberOfLines={2}>Managing {favourites.length} personal code blocks in your library.</DevText>
      </View>
